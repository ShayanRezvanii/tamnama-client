      ...
      <div className=" w-full flex flex-col justify-between">
        <div className=" flex justify-between w-full">
          <div className="  flex-col flex items-start gap-y-4 relative">
            <h1 className=" text-white text-[110px] z-20 ">امکانات</h1>
            <div className="bg-gradient-to-l rounded-tr-[120px]  rounded-bl-[120px] from-[#FF6000] to-white/30 absolute top-20 w-full  rotate-[-190deg] h-10 z-10"></div>
